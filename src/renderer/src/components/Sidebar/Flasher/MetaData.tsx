  ...
  return (
    ...
    >
      ...
      <Modal isOpen={isHelpOpen} onRequestClose={onHelpClose} title={'Справка'}>
        <div>
          Метаданные — это техническая информация, полученная с платы. С помощью метаданных определяется 
          тип платы. Эти данные могут быть полезны для разработчиков, в случае, если с платой что-то не так.
        </div>
        ...
        <div>
          ...
          должна быть подключена. Если данные не удаётся получить, возможно, следует обновить драйвера.
        </div>
      </Modal>
    </Modal>
  );
